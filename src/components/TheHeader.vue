      ...
      <div class="login">
        ...
        <ul v-if="this.store.auth.isLoggedIn == true">
          <li>
            ...
            <ul class="info">
              <li id="user-profile">
                <router-link to="/user-profile">Thông tin cá nhân</router-link>
              </li>
              <li id="changePassword">
                <router-link to="/changePassword">Đổi mật khẩu</router-link>
              </li>
              <li>
                <router-link to="/myOrder">Đơn Hàng Của Tôi</router-link>
              </li>
            </ul>
          </li>
          <li>
            ...
            <ul>
              ...
              <li class="has-sub">
                ...
                <ul>
                  ...
                  <li>
                    <a href="/categoryView/2">Cây thủy sinh</a>
                  </li>
                  <li>
                    <a href="/categoryView/3">Cây cảnh nội thất</a>
                  </li>
                  <li>
...
export default {
  ...
  async created() {
    const res = await this.store.getProfile();
  },
  methods: {
